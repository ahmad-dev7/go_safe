                    ...
                    children: [
                      ...
                      BlocBuilder<LoginSignupSwitchCubit, LoginSignupSwitchState>(
                        ...
                        builder: (context, loginSignupSwitchState) {
                          bool isLogin = loginSignupSwitchState is LoginState;
                          return BlocBuilder<LoginCubit, LoginState>(
                            builder: (context, loginActionState) {
                              return BlocBuilder<LoginSignupSwitchCubit, LoginSignupSwitchState>(
                                  builder: (context, signupActionState) {
                                return InkWell(
                                  onTap: () {},
                                  child: VxBox(
                                    child: (isLogin ? "Login" : "Signup").text.white.bodyLarge(context).makeCentered(),
