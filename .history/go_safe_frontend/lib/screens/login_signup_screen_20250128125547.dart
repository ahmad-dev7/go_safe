                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      //! there is a doubt that since the bloc builder for login & signup is available below
                      //! then is it needed to perform these actions under bloc listeners
                      //! or can we perform these actions in respective bloc builders as well.
                      //* Submit button
                      MultiBlocListener(
                        listeners: [
                          BlocListener<LoginCubit, LoginState>(
                            listener: (ctx, loginState) {
                              ...
                              if (loginState is LoginFailed) {
                                showSnackBar(ctx, title: "Oops! Login failed", message: loginState.error);
                              }
                            },
                          ),
                          BlocListener<SignupCubit, SignupState>(
                            listener: (ctx, signupState) {
                              ...
                              if (signupState is SignupFailed) {
                                showSnackBar(ctx, title: "Oops! Signup failed", message: signupState.error);
                              }
                            },
                          ),
                        ],
