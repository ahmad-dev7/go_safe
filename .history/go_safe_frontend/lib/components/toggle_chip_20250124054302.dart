            ...
            Align(
              ...
              child: CupertinoButton(
                ...
                child: "Login"
                    .text
                    .semiBold
                    .color(state is LoginSwitch ? AppColors.background(context) : AppColors.secondary(context))
                    .make(),
            ...
            Align(
              ...
              child: CupertinoButton(
                ...
                child: "Signup"
                    .text
                    .semiBold
                    .color(state is SignupSwitch ? AppColors.background(context) : AppColors.secondary(context))
                    .make(),
              ).box.width(context.percentWidth * 25).make(),
            ),
          ],
