        ...
        FloatingSearchBarAction(
          ...
          builder: (BuildContext context, Animation<double> animation) {
            ...
            return AnimatedSwitcher(
              ...
              child: IconButton(
                // Key ensures the AnimatedSwitcher knows when to transition
                key: ValueKey(bar.isOpen), // Use the state to switch between icons
                icon: Icon(
                  bar.isOpen && !bar.isAlwaysOpened ? Icons.arrow_back : Icons.map,
                  color: Colors.black, // Set the desired icon color
                  size: 24.0, // Set the desired icon size
                ),
                ...
                onPressed: () {
                  if (bar.isOpen && !bar.isAlwaysOpened) {
                    ...
                    // Handle action when map icon is clicked
