    ...
    return Stack(
      children: [
        ...
        Align(
          ...
          child: VxBox().color(AppColors.primary(context)).width(context.percentWidth * 25).withRounded().make(),
        ),
        Align(
          alignment: Alignment.centerLeft,
          child: CupertinoButton(
            padding: const EdgeInsets.all(0),
            child: "Login".text.semiBold.color(Theme.of(context).colorScheme.background).make(),
            onPressed: () {},
