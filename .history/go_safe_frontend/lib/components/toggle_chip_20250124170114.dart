  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LoginSignupSwitchCubit, LoginSignupSwitchState>(
      builder: (context, state) {
        ...
        return Stack(
          children: [
            ...
            AnimatedAlign(
              ...
              child: VxBox().color(AppColors.accent(context)).width(context.percentWidth * 30).withRounded().make(),
            ),
            //* Login button
            Align(
              ...
              ).box.width(context.percentWidth * 30).make(),
            ),
            //* Signup button
            Align(
        ...
        ).box.width(context.percentWidth * 55).height(45).makeCentered();
      },
    );
  }
}
