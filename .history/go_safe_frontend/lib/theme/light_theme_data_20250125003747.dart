...
class LightThemeData {
  static ThemeData themeData = ThemeData.light().copyWith(
    ...
    inputDecorationTheme: const InputDecorationTheme(
      filled: true,
      fillColor: Color(0xFFffffff), // Input field background color
      focusedBorder: OutlineInputBorder(
        borderSide: BorderSide(width: 2, color: Color(0xFF16bc88)), // Accent color for focused input
      ),
      enabledBorder: OutlineInputBorder(
        borderSide: BorderSide(width: 1, color: Color(0xFF6b7280)), // Accent for enabled input
      ),
    ),
  );
}
