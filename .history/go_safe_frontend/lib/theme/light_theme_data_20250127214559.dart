  ...
  static ThemeData themeData = ThemeData.light().copyWith(
    colorScheme: const ColorScheme.light().copyWith(
      ...
      primaryContainer: const Color(
          0xFFffffff), //* For containers just on top of scaffold [Primary Container]
      onPrimaryContainer: const Color(
          0xFFf9fafb), //* For for containers on top of primary container
    ...
    textSelectionTheme: const TextSelectionThemeData(
      ...
      selectionHandleColor:
          Color(0xFF16bc88), // Selection handle (drag point) color
    ),
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: const BorderSide(
            color: Color(0xFF16bc88)), // Accent color for focused input
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(15),
        borderSide: const BorderSide(
            color: Color(0x6F6B7280)), // Accent for enabled input
      ),
